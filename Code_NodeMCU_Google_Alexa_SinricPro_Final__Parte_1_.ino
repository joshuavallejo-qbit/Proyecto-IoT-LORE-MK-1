...
#define APP_KEY           "668b9182-eca6-4cd4-a147-f662d6ad0c5a"      // Debería verse así: "de0bxxxx-1x3x-4x3x-ax2x-5dabxxxxxxxx"
#define APP_SECRET        "06e67430-47e7-4ffc-b850-6e59da73cc7a-88537f07-7875-4c43-9773-d37a4ab1f1d0"   // Debería verse así: "5f36xxxx-x3x7-4x3x-xexe-e86724a9xxxx-4c4axxxx-3x3x-x5xe-x9x3-333d65xxxxxx"
...
bool onPowerState(String deviceId, bool &state)
{
  ...
  int relayPIN = devices[deviceId].relayPIN; //obtenemos el pin del relay asociado al dispositivo respectivo
    ...
    if (actualMillis - lastFlipSwitchChange > DEBOUNCE_TIME) {                    // Si el tiempo que pasó es mayor al tiempo de respuesta
      ...
      if (flipSwitchState != lastFlipSwitchState) {                               // Si el estado ha cambiado...
        ...
        if (flipSwitchState) {                                                    
          ...
          SinricProSwitch &mySwitch = SinricPro[deviceId];                        // traemos el estado del switch y lo asociamos a la función Sinric Pro
